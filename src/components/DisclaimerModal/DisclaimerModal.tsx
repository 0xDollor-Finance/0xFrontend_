  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>We will start Farming on blocks 10903900 (Sep 21st 05:30 UTC) and start Flash loan arbitrage in a few weeks.</p>
          <p>
            While the initial creators of the 0xDollar protocol have made
      ...
      return (
        <div>
          <p>Attention 0xDOLLAR Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with 0xDOLLAR is 0xDOLLAR/yCRV
            (Curve yPool tokens)
          </p>
