...
import DollorAbi from './abi/dollor.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.dollor = new this.web3.eth.Contract(DollorAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.dollor, contractAddresses.dollor[networkId])
  ...
  setDefaultAccount(account) {
    this.dollor.options.from = account
